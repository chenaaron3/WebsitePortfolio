    ...
    render() {
        return (
            <div className="sidebar" data-aos="fade-right">
                <a href="https://github.com/chenaaron3" target="_blank" rel="noopener noreferrer">
                ...
                <a href="https://www.linkedin.com/in/aaron-chen-062647187/" target="_blank" rel="noopener noreferrer">
                    <svg className="logo" viewBox="0 0 24 24">

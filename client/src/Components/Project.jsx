                ...
                <div data-aos="zoom-in-up">
                    <div className={`project ${this.props.pictures ? "block" : "card"}`}>
                        <div className="project-header">
                            {this.props.github &&
                                <a href={this.props.github} target="_blank" rel="noopener noreferrer" className="project-external-link">
                            ...
                            {this.props.extLink &&
                                <a href={this.props.extLink} target="_blank" rel="noopener noreferrer" className="project-external-link">
                                    <svg>
